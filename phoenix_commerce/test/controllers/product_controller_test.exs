defmodule PhoenixCommerce.ProductControllerTest do
  ...
  @upload %Plug.Upload{path: Path.relative_to_cwd("test/files/logo-email-b32a431e5255c913b4959a8a99016066.png"), filename: "logo-email-b32a431e5255c913b4959a8a99016066.png", content_type: "image/png"}
